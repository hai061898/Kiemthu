	      ...
	      <section class="content">
	        <div class="row">
	            ...
	            <?php
	       			...
	       			$row = $stmt->fetch();// tim kiem giong toan tu like csdl
	       			if($row['numrows'] < 1){
	       				echo '<h1 class="page-header">Không tìm thấy sản phẩm : <i>'.$_POST['keyword'].'</i></h1>';
	       			}
	       			else{
	       				echo '<h1 class="page-header">Kết quả tìm kiếm sản phẩm : <i>'.$_POST['keyword'].'</i></h1>';
		       			try{
		       			 	$inc = 3;	
