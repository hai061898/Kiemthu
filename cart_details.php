	...
	if(isset($_SESSION['user'])){
			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td>".$row['name']."</td>
						<td> ".number_format($row['price'])." &#208;</td>
						...
						<td> ".number_format($subtotal)." &#208;</td>
					</tr>
				";
			}
			$output .= "
				<tr>
					...
					<td><b> ".number_format($total)."&#208;</b></td>
		...
		if(count($_SESSION['cart']) != 0){
			...
			foreach($_SESSION['cart'] as $row){
				...
				$output .= "
					<tr>
						...
						<td><img src='".$image."' width='30px' height='30px'></td>
						<td>".$product['name']."</td>
						<td> ".number_format($product['price'])." &#208;</td>
						<td class='input-group'>
							<span class='input-group-btn'>
			...
			$output .= "
				<tr>
					<td colspan='5' align='right'><b>Tổng</b></td>
					<td><b> ".number_format($total, 2)." &#208;</b></td>
